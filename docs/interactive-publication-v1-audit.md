...
- Start Here: the page now identifies the four-volume project and author in the hero, places the volume guide first, and then deep-links its five guided cards to pathway plugins with core ideas and public entry points.
