...
| Discovery          | Home cards, six coverage fields, four-volume roadmap   | `/start/`, six topic hubs, five question pathways with discovery plugins for primary volume, core ideas, and public entry points, plus a four-volume research spine linking each volume to its subject lenses and selected public work                                |
...
- Start Here: the five guided cards now deep-link to their pathway plugins, and the page includes the same four-volume map with core ideas and public entry points.
