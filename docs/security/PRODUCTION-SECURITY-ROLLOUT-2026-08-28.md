...
- Reviewed head: `beff0109ca63b0d1d5a8ee043cedefe75e4e556f`
...
- Reviewed Preview: `dpl_5fvFahsKi4bCvWvNYvdNhNy6RfUY`, READY, exact reviewed head, PR #30
...
| -------------------- | --------------------- | ------------------------------------------------------------------------------------------ |
| CI                   | PASS                  | GitHub run `33174666205`                                                                   |
| CodeQL               | PASS                  | GitHub run `33174666202`                                                                   |
| Dependency security  | PASS                  | Platform-independent lockfile/audit run `33174666231`                                      |
...
| Preview deployment   | PASS                  | `dpl_5fvFahsKi4bCvWvNYvdNhNy6RfUY` READY and exact head match                              |
