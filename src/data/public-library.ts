...
export const publicLibrarySnapshot = {
  ...
  stats: [
    { label: "Source folders reviewed", value: "15", detail: "Aggregate count from the reviewed public export." },
    { label: "Source files inventoried", value: "341", detail: "Inventory context only; files remain in the private archive." },
    { label: "Public volume summaries", value: "3", detail: "High-level summaries available on this site." },
    { label: "Raw files published", value: "0", detail: "No DOCX, PDF, video, or working archive file is exposed here." },
  ...
  areas: [
    { title: "Primary research body", summary: "Core Independent Observer volumes and their evidence-led research structure.", privateCount: "260 files in the private archive" },
    { title: "Forward-looking research", summary: "Future-society and technology work, including questions about systems, capability, and change.", privateCount: "12 files in the private archive" },
    { title: "Video and visual development", summary: "Media and presentation work that may support future public explanations and documentaries.", privateCount: "30 files in the private archive" },
    { title: "Project stewardship", summary: "Rights, licensing, and protection materials that support responsible publication.", privateCount: "4 files in the private archive" },
    { title: "Working material", summary: "Supplemental research folders retained for review and future editorial decisions.", privateCount: "30+ files in the private archive" },
