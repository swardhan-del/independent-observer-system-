...
export const archiveFamilyIds = {
  ...
  platoToChomsky: "IO-FAMILY-PLATO_TO_CHOMSKY",
  formationThroughStruggle: "IO-FAMILY-FORMATION_THROUGH_STRUGGLE",
  civilRightsRealignment: "IO-FAMILY-CIVIL_RIGHTS_REALIGNMENT",
  welfareQueenTaxCut: "IO-FAMILY-WELFARE_QUEEN_TAX_CUT",
  partySwitchPolarization: "IO-FAMILY-PARTY_SWITCH_POLARIZATION",
} as const;
...
const aliasToFamilyId: Record<string, string> = {
  ...
  "from-plato-to-chomsky": archiveFamilyIds.platoToChomsky,
  "plato-to-chomsky": archiveFamilyIds.platoToChomsky,
  "io-family-plato-to-chomsky": archiveFamilyIds.platoToChomsky,
  "formation-through-struggle": archiveFamilyIds.formationThroughStruggle,
  "io-family-formation-through-struggle": archiveFamilyIds.formationThroughStruggle,
  "civil-rights-realignment": archiveFamilyIds.civilRightsRealignment,
  "civil-rights-realignment-party-sorting": archiveFamilyIds.civilRightsRealignment,
  "io-family-civil-rights-realignment": archiveFamilyIds.civilRightsRealignment,
  "welfare-queen-tax-cut": archiveFamilyIds.welfareQueenTaxCut,
  "welfare-queen-and-the-tax-cut": archiveFamilyIds.welfareQueenTaxCut,
  "io-family-welfare-queen-tax-cut": archiveFamilyIds.welfareQueenTaxCut,
  "party-switch-polarization": archiveFamilyIds.partySwitchPolarization,
  "party-switch-and-polarization": archiveFamilyIds.partySwitchPolarization,
  "io-family-party-switch-polarization": archiveFamilyIds.partySwitchPolarization,
