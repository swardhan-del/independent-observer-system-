...
export const seriesItems: SeriesItem[] = [
  {
    ...
    detailSections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Three Volume I papers currently have matched public paper records: the Foundational Manifesto, A Systems-Centered Manifesto on Automation, Education, and the Carceral State, and The Illusion of Equality. The Illusion of Equality’s volume placement is in editorial development; the other titles above are mapped research directions. Naming them here does not claim that they are public paper records or released publications.",
